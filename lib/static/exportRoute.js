...
var _jsxFileName = "/Users/mbrowne/GoogleDrive/www/react-static/react-static-fork/packages/react-static/src/static/exportRoute.js";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            srcReplace = cachedSrcReplace || (cachedSrcReplace = new RegExp("(src=[\"'])\\/(".concat(basePath ? "".concat(basePath, "\\/") : '', ")?([^\\/])"), 'gm')); // mbrowne added

            linkHrefReplace = cachedLinkHrefReplace || (cachedLinkHrefReplace = new RegExp('(<link\\s[^>]*href=["\'])\\/', 'gm')); // This routeInfo will be saved to disk. It should only include the
          ...
          case 68:
            ...
            if (process.env.REACT_STATIC_DISABLE_ROUTE_PREFIXING !== 'true') {
              html = html.replace(hrefReplace, "$1".concat(publicPath, "$3"));
                ...
                html = html.replace(linkHrefReplace, "$1".concat(publicPath));
              }
...
(function () {
  ...
  reactHotLoader.register(cachedBasePath, "cachedBasePath", "/Users/mbrowne/GoogleDrive/www/react-static/react-static-fork/packages/react-static/src/static/exportRoute.js");
  reactHotLoader.register(cachedHrefReplace, "cachedHrefReplace", "/Users/mbrowne/GoogleDrive/www/react-static/react-static-fork/packages/react-static/src/static/exportRoute.js");
  reactHotLoader.register(cachedSrcReplace, "cachedSrcReplace", "/Users/mbrowne/GoogleDrive/www/react-static/react-static-fork/packages/react-static/src/static/exportRoute.js");
  reactHotLoader.register(cachedLinkHrefReplace, "cachedLinkHrefReplace", "/Users/mbrowne/GoogleDrive/www/react-static/react-static-fork/packages/react-static/src/static/exportRoute.js");
})();
